...
//         	var_dump($manipulation);die;
    ...
    public function requireExtraTable($locale, $includedFields) {
    	...
    	if($this->owner->hasExtension('Versioned')){
    		...
    		$this->requireExtraVersionedTable($this->owner->class, $includedFields);
...
//     			DB::require_table("{$this->owner->class}_$relationship", $manymanyFields, $manymanyIndexes, true, null,
//     			$extensions);
//     		}
//     	}
    }
    ...
    protected $stages = array('Stage', 'Live');
    protected $defaultStage = 'Stage';
    
    public function requireExtraVersionedTable($classTable, $includedFields){
    	...
    	$fluentLocales = Config::inst()->get('Fluent', 'locales');
		...
		$allSuffixes = array();
		if($fluentLocales && count($fluentLocales)){
			$allSuffixes = array_merge($allSuffixes, (array)$fluentLocales);
		}
